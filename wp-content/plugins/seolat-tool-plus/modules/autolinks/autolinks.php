...
class SL_Autolinks extends SL_Module {
	static function get_module_title() { return __('Deeplink Juggernaut', 'seolat-tool-plus'); }
	static function get_menu_title() { return __('Deeplink Juggernaut', 'seolat-tool-plus'); }
	
	function add_help_tabs($screen) {
		
		$screen->add_help_tab(array(
			  'id' => 'sl-autolinks-overview'
...
", 'seolat-tool-plus')));
		...
		$screen->add_help_tab(array(
			  'id' => 'sl-autolinks-content-links'
			, 'title' => __('Content Links Tab', 'seolat-tool-plus')
			, 'content' => __("
...
", 'seolat-tool-plus')));
		...
		$screen->add_help_tab(array(
			  'id' => 'sl-autolinks-content-link-settings'
			, 'title' => __('Content Link Settings Tab', 'seolat-tool-plus')
			, 'content' => __("
...
", 'seolat-tool-plus')));
		...
		$screen->add_help_tab(array(
			  'id' => 'sl-autolinks-footer-links'
			, 'title' => __('Footer Links Tab', 'seolat-tool-plus')
			, 'content' => __("
...
", 'seolat-tool-plus')));
		...
		$screen->add_help_tab(array(
			  'id' => 'sl-autolinks-footer-link-settings'
			, 'title' => __('Footer Link Settings Tab', 'seolat-tool-plus')
			, 'content' => __("
...
<ul>
	...
	<li><strong>Does Deeplink Juggernaut edit my posts&#8217; content as it is stored in the database?</strong><br />No. Autolinks are added dynamically. This means all the autolinks will go away if you disable Deeplink Juggernaut or deactivate SEO LAT+.</li>
