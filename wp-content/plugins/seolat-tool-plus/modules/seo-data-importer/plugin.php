...
/**
 * Initialize the SEO Data Importer plugin
 */
function seodt_init() {
	...
	$_seodt_plugins = array(
		...
		'SEO LAT' => array(
			'Custom Doctitle' => '_sl_title',
			'META Description' => '_sl_description',
			'META Keywords' => '_sl_keywords',
			'noindex' => '_sl_meta_robots_noindex',
			'nofollow' => '_sl_meta_robots_nofollow',
		),
		'WordPress SEO' => array(
