...
class SL_Canonical extends SL_Module {

	static function get_module_title() { return __('Canonicalizer', 'seolat-tool-plus'); }
	...
	function admin_page_contents() {
		...
		$this->checkboxes(array(
				  'link_rel_canonical' => __('Generate <code>&lt;link rel=&quot;canonical&quot; /&gt;</code> meta tags', 'seolat-tool-plus')
				, 'http_link_rel_canonical' => __('Send <code>rel=&quot;canonical&quot;</code> HTTP headers', 'seolat-tool-plus')
			), __('Canonical URL Generation', 'seolat-tool-plus'));
		$this->radiobuttons('canonical_url_scheme', array(
			  '' => __('Use <code>http://</code> or <code>https://</code> depending on how the visitor accessed the page', 'seolat-tool-plus')
			, 'http' => __('Make all canonical URLs begin with <code>http://</code>', 'seolat-tool-plus')
			, 'https' => __('Make all canonical URLs begin with <code>https://</code>', 'seolat-tool-plus')
		), __('Canonical URL Scheme', 'seolat-tool-plus'));
		$this->checkboxes(array(
				  'remove_nonexistent_pagination' => __('Redirect requests for nonexistent pagination', 'seolat-tool-plus')
			), __('Automated 301 Redirects', 'seolat-tool-plus'));
		$this->child_admin_form_end();
		
		echo "<p class='admin_subtitle'>Click Here for<a href='/wp-admin/admin.php?page=sl-canonical-url'> Additional Canonical Settings</a>.</p>";
	}
