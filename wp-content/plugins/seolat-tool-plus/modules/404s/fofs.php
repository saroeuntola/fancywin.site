...
class SL_Fofs extends SL_Module {
	static function get_module_title() { return __('404 Monitor', 'seolat-tool-plus'); }
	static function get_menu_title() { return __('404 Monitor', 'seolat-tool-plus'); }
...
", 'seolat-tool-plus')));
		...
		$screen->add_help_tab(array(
			  'id' => 'sl-fofs-log'
			, 'title' => __('Log Help', 'seolat-tool-plus')
			, 'content' => __("
...
", 'seolat-tool-plus')));
		...
		$screen->add_help_tab(array(
			  'id' => 'sl-fofs-settings'
			, 'title' => __('Settings Help', 'seolat-tool-plus')
			, 'content' => __("
