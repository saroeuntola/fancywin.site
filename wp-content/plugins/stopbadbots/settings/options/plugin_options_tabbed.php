	...
	$fields[] = array(
		...
		$fields[] = array(
			...
			'select_options' => array(
				...
				array(
					'value' => '1',
					'label' => __( '1 day', 'stopbadbots' ),
				),
				array(
					'value' => '3',
					'label' => __( '3 days', 'stopbadbots' ),
				),
				array(
					'value' => '7',
					'label' => __( '7 days', 'stopbadbots' ),
				),
				array(
					'value' => '14',
					'label' => __( '14 days', 'stopbadbots' ),
				),
				array(
					'value' => '21',
					'label' => __( '21 days', 'stopbadbots' ),
				),
				array(
					'value' => '30',
					'label' => __( '30 days', 'stopbadbots' ),
				),
				array(
					'value' => '90',
					'label' => __( '90 days', 'stopbadbots' ),
				),
				array(
					'value' => '180',
					'label' => __( '180 days', 'stopbadbots' ),
				),
				array(
					'value' => '360',
					'label' => __( '360 days', 'stopbadbots' ),
				),
			),
		);
		/*
